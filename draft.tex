...
\textit{Who am I} is a question of humankind. Many try to find an answer to it - and if not, they will be confronted with opinions of others without being asked. Sociologist Abels describes identity as the answer to the question. 
In addition to that, he proposes the thesis that in advanced modernity we are increasingly asked the question of our own identity. 
...
According to Abels, identity is a term that decides individuals from one another\cite{abelsidentity}.
...
To pursue all approaches would probably require a separate paper.
...
They persist irrespective of damage to DNA due to random accidents. The sequences do not depend on cognitive abilities or consciousness. 
...
In 2018, the global direct-to-consumer genetic test market was valued at approximately 824.1 million USD and is estimated to grow to 6,364.5 million USD by 2028. This is more than an estimated sevenfold increase over a 10-year period.
...
However, this does not exclude the possibility of untruths being told about one's own family history or documents being embellished. 
...
Giving people knowledge of their genetic code, advocates of such services argue, can help them make better decisions about lifestyle and health. 
...
According to Interpol, 63 percent of the asked National Central Bureaus reported having a DNA database (a searchable repository) which store over 10 million DNA profiles combined\cite{interpol}. 
...
DNA should nevertheless be tracked and used carelessly. However, statistics from the German Federal Criminal Police Office show that in addition to theft or murder, cases of verbal abuse have also led to hits in DNA analysis\cite{bkastat}. 
...
The law followed a deadly suicide attack on a mosque in the country's capital\cite{kuweit1}. Fortunately, the country's Constitutional Court ruled that the law violates the constitutional guarantee of personal freedom\cite{kuweit2}.
