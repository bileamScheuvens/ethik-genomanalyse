...
Even if we do not ask ourselves who we are, we will receive unprompted answers. Sociologist Abels describes identity as the answer to the question \textit{who am I} and therefore, identity as a differentiating term.\cite{abelsidentity} 

Market leader Ancestry states to have over 20 million people in their database and therefore the world’s largest consumer DNA network\cite{aboutancestry}. What do people hope to gain from their DNA tests and what does it have to do with our identity? Great examples for DNA information leading to a new self-understanding are "I am P’s father" (based on a paternity test) or "I am an African-American with my roots in Nigeria" (based on genetic ancestry tracing). In this case, identity is not only a matter of a unique narrative identity but also of numerical identity, id est identity in terms of individual continuity-over-time.\cite{nordgren} 
...
Many genetic testing companies appeal in their rhetoric to identity: The individualistic visions of identity is implicitly expressed in these quotations are clear examples of genetic individualism. 
Genetic individualism is the view that the DNA of an individual gives the individual a unique identity\cite{nordgren}.
 As mentioned in the chapter before, modern societies are searching for identity and this rhetoric is a response to that\cite{nordgren}.
...
Giving people knowledge of their genetic code, advocates of such services argue, can help them make better decisions about lifestyle, health, and medical care. 
But what happens to the sensitive data? 
The two biggest market players Ancestry and 23andMe have a combined DNA Database Size of 32+ million\cite{aboutancestry}\cite{about23andme}. 

Laestadius, Rich \& Auer investigated 30 different direct-to-consumer genetic testing websites for two aspects. 
The first aspect being transperency regarding confidentiality and privacy. As a second aspect, the use of data, professional and government bodies created guidelines to promote transparency among these companies was analysed. 
...
With the progression of forensic genetics in the last 35 years, many authors of crimes have been identified because of the ability to extract DNA profiles\cite{machado}.
...
??? MÖGLICHKEITEN ÜBER LÖSCHUNG DER DATEN IN ANDEREN LÄNDERN HERAUSSUCHEN ???
